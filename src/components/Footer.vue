    ...
    <div class="container-footer-all">
      <div class="container-body">
        <div class="colum1">
          ...
          <p>
            Este sitio se dedica a la venta de equipo gamer, desde los artículos
            más utilizados, hasta información y noticias más relevantes del
            tema.
          </p>
        </div>
        ...
        <div class="colum3">
          ...
          <div class="row2">
            <img
              src="https://img.icons8.com/doodle/48/000000/google-maps-new.png"
            />
          ...
          <div class="row2">
            <img
              src="https://img.icons8.com/ultraviolet/40/000000/phone-office.png"
            />
          ...
          <div class="row2">
            <img
              src="https://img.icons8.com/color/48/000000/important-mail.png"
            />
